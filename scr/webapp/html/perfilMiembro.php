                    ...
                    if(existeMiembro($dniMiembro)=='NO'){
                        ...
                        <div class="seccionPerfil cuenta">
                            ...
                            <?php if(existeCuenta($dniMiembro)=='NO'){ ?>
                                ...
                                <a href="crearUsuario.php"><button class="button">Crear cuenta</button></a>
                            <?php } else if(existeCuenta($dniMiembro)=='SI'){
                                ...
                                <div class="subSeccionPerfil">
                                    ...
                                    <div class="contenedorDato">
                                        <span class="nombreDato">Tipo de Cuenta: </span><span><?= $infoCuenta[0]['TIPOUSUARIO']?></span>
                                    </div>
                                </div>
                                <div class="subSeccionPerfil">
                                    <div class="contenedorDato">
                                        <form method="post" action="editarCuenta.php" id="formularioEditarCuentaPerfil">
                                            <input type="hidden" name="usuario" value="<?= $infoCuenta[0]['USUARIO']?>">
                                            <button class="button">Editar Cuenta</button>
                                        </form>
                                    </div>
                                    <div class="contenedorDato">
                                        <form method="post" action="../php/phpAdmin/Miembros/eliminarCuenta.php" id="formularioEliminarCuentaPerfil">
                                            <input type="hidden" name="usuario" value="<?= $infoCuenta[0]['USUARIO']?>">
                                        </form>
                                        <button class="button" onclick="alertaEliminarCuentaDesdePerfil()">Eliminar Cuenta</button>
                                    </div>
                                </div>
